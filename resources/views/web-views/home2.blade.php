            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row ml-2 mr-3 mb-2" id="bestSel">
                            @foreach($bestSellProduct as $key=>$bestSell)
                                @if($bestSell->product && $key<4)
                                     
                                    <div class="col m-1" style="border-style: solid;
                        ...
                        <div class="owl-carousel owl-theme " id="new_owl">
                          @foreach($bestSellProduct as $key=>$bestSell)
                            @if($bestSell->product && $key<4)                                      
                              <div class="item">
                                <div class="col m-1" style="border-style: solid;
                                      border-color: #0000000d; border-radius:5px;"
                                          ...
                                          @if($bestSell->product->discount > 0)
                                              ...
                                              @endif
                                            <div class="row" style="padding:8px;margin-left: 35px ">

                                                <div class="best-selleing-image"  >
                                                    <a class="d-block d-flex justify-content-center" style="width:100%;max-height:160px;"
                                                        href="{{route('product',$bestSell->product->slug)}}">
                                                        <img style="border-radius:5px;"
                                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                            src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$bestSell->product['thumbnail']}}"
